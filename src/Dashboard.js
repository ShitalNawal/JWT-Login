  ...
  return (
    <div className="w-1/4 mb-8 ">
      ...
      <div className="relative h-4 rounded-full bg-gray-200 ml-2">
        <div
          className="absolute left-0 top-0 h-full bg-cyan-800 rounded-full "
    ...
    <main className=" h-screen relative">
      ...
      <div className="flex flex-col items-center justify-center h-full text-center font-bold bg-gradient-to-r from-cyan-300 via-blue-300 to-violet-300 ">
        <div className="text-teal-800 font-sacramento text-6xl relative z-10 leading-tight">
          <div className="flex">
            <h1 className="text-6xl mr-2">Hello</h1>
            <span>👋</span>

          </div>
          <div className="relative">
            I'm <span className="text-rose-600">Shital</span>
          </div>
          <div className="text-2xl mt-4 relative">
            a <span className="text-rose-600">Web Developer</span>
          </div>
          <Link to="/contact">
            <button
              type="submit"
        ...
        <img
          src="/bg-main.jpg"
          alt="mountain"
          className="absolute inset-0 object-cover w-full h-screen opacity-70 z-0 "
        />
      </div>
      <div className="text-rose-600 text-4xl text-center pt-4 font-bold underline bg-gradient-to-r from-cyan-300 via-blue-300 to-violet-300">
        Skills
      </div>
